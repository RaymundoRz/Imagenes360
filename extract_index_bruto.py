#!/usr/bin/env python3
"""
Script para extraer index.html EN BRUTO tal como viene de Honda
"""
...
def extract_index_bruto():
    """Extraer index.html EN BRUTO desde Honda"""
    ...
    try:
        ...
        # URL del index.html real de Honda
        url = "https://www.honda.mx/web/img/cars/models/city/2026/city_2026_int_360/index.html"
        ...
        output_dir = Path("backend/downloads/honda_city_2026/ViewType.INTERIOR")
        ...
        print(f"💾 INDEX.HTML GUARDADO EN BRUTO: {viewer_file}")
        ...
        print(f"💾 INDEX.HTML ORIGINAL GUARDADO: {index_file}")
